...
NodeMsg::NodeMsg(const char *name, short kind) : ::omnetpp::cMessage(name, kind)
{
}

NodeMsg::NodeMsg(const NodeMsg& other) : ::omnetpp::cMessage(other)
{
    copy(other);
}
...
int NodeMsg::getSource() const
{
    return this->source;
}

void NodeMsg::setSource(int source)
{
    this->source = source;
}

int NodeMsg::getDestination() const
{
    return this->destination;
}

void NodeMsg::setDestination(int destination)
{
    this->destination = destination;
}

int NodeMsg::getHopCount() const
{
    return this->hopCount;
}

void NodeMsg::setHopCount(int hopCount)
{
...
NodeMsgDescriptor::NodeMsgDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(NodeMsg)), "omnetpp::cMessage")
{
